...
DB_FILENAME: str = os.environ.get("DB_FILENAME")
CSV_FILE: str = "NOMBRE_DEL_ARCHIVO"
    ...
    def _load(self) -> Dict[str, Any]:
        try:
            with self._connect() as conn:
                ...
                conn.execute("INSERT OR IGNORE INTO stats (key, value) VALUES ('total', 0)")
                conn.execute("INSERT OR IGNORE INTO stats (key, value) VALUES ('total', 0)")
                conn.commit()
